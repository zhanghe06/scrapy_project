...
class Crawl58ServiceV4Spider(scrapy.Spider):
    name = "crawl58_service_v4"
...
# scrapy genspider crawl58_service_v4 58.com
# scrapy crawl crawl58_service_v4 -s JOBDIR=crawls/app/crawl58_service_v4

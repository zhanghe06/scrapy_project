...
class Crawl58ServiceDianqiV4Spider(scrapy.Spider):
    name = "crawl58_service_dianqi_v4"
...
# scrapy genspider crawl58_service_dianqi_v4 58.com

# scrapy crawl crawl58_service_dianqi_v4 -s JOBDIR=crawls/app/crawl58_service_dianqi_v4

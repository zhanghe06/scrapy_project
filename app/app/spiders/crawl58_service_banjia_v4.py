...
class Crawl58ServiceBanjiaV4Spider(scrapy.Spider):
    ...
    def parse_detail(self, response):
        ...
        company_address_re_list = response.xpath('//div[@class="userinfo"]/ul[@class="uinfolist"]/li').re(company_address_re_compile)
        company_address = company_address_re_list[0].strip() if company_address_re_list else ''
        company_reg_date_re_list = response.xpath('//div[@class="userinfo"]/ul[@class="uinfolist"]/li').re(company_reg_date_re_compile)
        ...
        verified_company = int(response.xpath('//span[@class="ico-rzv-b"]/@title').extract_first(default='').strip() == u'企业执照已认证')

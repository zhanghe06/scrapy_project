...
class Crawl58ServiceBaojieSpider(scrapy.Spider):
    name = "crawl58_service_baojie_v4"
...
# scrapy genspider crawl58_service_baojie_v4 58.com

# scrapy crawl crawl58_service_baojie_v4 -s JOBDIR=crawls/app/crawl58_service_baojie_v4

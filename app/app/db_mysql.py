...
DB_SCHEMA_PATH = os.path.join(BASE_DIR, 'db_schema_mysql.sql')
DUMP_FILE_PATH = os.path.join(BASE_DIR, 'dump_file_mysql.sql')
...
def usage():
    print """
建库 建表（初始化数据库）
$ python db_mysql.py create_db

导出建表语句（备份数据库）
$ python db_mysql.py dump_db
"""
